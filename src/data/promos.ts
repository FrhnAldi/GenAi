...
export const PROMOS: Promo[] = [
  ...
  },
  {
    ...
    accent: '#A85C34',
    tag: 'Paket Keluarga',
    title: 'Paket Nusantara untuk 4 Orang',
    description: '4 menu utama + 4 minuman, hemat hingga 30% dari harga satuan.',
    code: 'KELUARGA4',
    image: 'https://images.unsplash.com/photo-1600891964092-4316c288032e?w=700&h=500&fit=crop&auto=format',
    discountPercent: 30,
    requirements: [
  ...
  },
  {
    ...
    code: 'HALORASANUSA',
    image: 'https://images.unsplash.com/photo-1499638673689-79a0b5115d87?w=700&h=500&fit=crop&auto=format',
    discountPercent: 10,
  ...
  },
  {
    ...
    code: 'JUMATPEDAS',
    image: 'https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?w=700&h=500&fit=crop&auto=format',
    discountPercent: 50,
